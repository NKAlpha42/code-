...
console.log("i'm scripting java");
...
var animal= "the cat walthozar bobalthozar feefifofalthazar the third";
...
document.getElementById('column1').innerHTML="Holy moly! A Mean thing about Tanya!";
document.getElementById('column2').innerHTML="<p>beans beans Beans BEans BEAns BEANs BEANS BEANS B EANS BE ANS BEA N S    B E A N S         B    E   A   N   S <p/>";
...
document.getElementById('column3').innerHTML += "<p>Opponent Health: "
 +health
 +"</p>";
